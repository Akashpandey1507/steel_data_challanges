...
CREATE TABLE `accounts` (
  ...
  CONSTRAINT `accounts_ibfk_2` FOREIGN KEY (`BranchID`) REFERENCES `branches` (`BranchID`)
...
-- Dump completed on 2024-01-13 20:46:26
